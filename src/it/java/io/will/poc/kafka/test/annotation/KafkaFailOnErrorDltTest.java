...
@Documented
@Inherited
@ContextConfiguration(classes = {DltFailOnErrorConsumer.class, RetryableProducer.class, RetryableProducerResource.class})
@EnableAutoConfiguration
@ComponentScan(value = {"io.will.poc.kafka.config"})
@ActiveProfiles("dlt")
public @interface KafkaFailOnErrorDltTest {
}
