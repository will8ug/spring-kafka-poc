...
@Documented
@Inherited
@ContextConfiguration(classes = {DltDisabledDltConsumer.class, RetryableProducer.class, RetryableProducerResource.class})
@EnableAutoConfiguration
@ComponentScan(value = {"io.will.poc.kafka.config"})
@ActiveProfiles("dlt")
public @interface KafkaDisabledDltTest {
}
